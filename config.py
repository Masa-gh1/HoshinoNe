...
# 最大ブロックサイズ[byte] (画像なら 縦x横x型)
MAX_BLOCK_SIZE_BYTES = BLOCK_SIZE * BLOCK_SIZE * DEFAULT_BLOCK_TYPE_BYTES

# ブロックキャッシュサイズ設定[GB]
MAX_BLOCK_CACHE_SIZE_GB = 8
MAX_BLOCK_CACHE_SIZE_BYTES = MAX_BLOCK_CACHE_SIZE_GB * 1024 * 1024 * 1024
MAX_BLOCK_CACHE_SIZE = MAX_BLOCK_CACHE_SIZE_BYTES // MAX_BLOCK_SIZE_BYTES # [ブロック数]

# ブロックキャッシュページサイズ [ブロック数]
BLOCK_CACHE_PAGE_SIZE = 1024
BLOCK_CACHE_PAGE_SIZE_BYTES = BLOCK_CACHE_PAGE_SIZE * MAX_BLOCK_SIZE_BYTES
